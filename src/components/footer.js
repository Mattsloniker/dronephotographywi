      ...
      <div className="site-footer" id="footer">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-6">
            ...
            <li><a href="mailto:HHPhotography@dronephotographywi.com"><h3>HHPhotography@dronephotographywi.com</h3></a></li>
            <li><a href="tel:608-313-4495"><h3>(608) 313-4495</h3></a></li>
            </ul>
          </div>
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links">
              ...
              <li><a href="https://dronephotographywi.com/#Testimonials"><h3>Testimonials</h3></a></li>
            </ul>
          </div>
          </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-8 col-sm-6 col-xs-12">
            ...
            <li><a href="https://dronephotographywi.com/"> HHPhotography</a></li>.
            </p>
          </div>
      </div>
      </div>
